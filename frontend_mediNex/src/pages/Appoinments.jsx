...
export default function Appointments() {
  ...
  useEffect(() => {
    const handler = (e) => {
      ...
      const slots = docSlots[slotInx];
      const currentIndex = slotTime
        ? slots.findIndex((s) => s.time === slotTime)
        : -1;
    ...
    <div className="bg-gradient-to-br from-blue-50 via-white to-indigo-50 min-h-screen pb-12 pt-8 px-4 md:px-10 flex flex-col items-center gap-6">
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      if (timeContainerRef.current)
                        timeContainerRef.current.scrollLeft = 0;
                    }}
                    className={`min-w-[88px] flex-shrink-0 px-4 py-2 rounded-xl cursor-pointer text-center shadow-sm transition-all duration-200 transform
                      ${
                        slotInx === idx
                          ...
                          : "bg-white/70 text-gray-800 hover:translate-y-[-3px]"
                      }
                    `}
              ...
              >
                        ...
                        <div
                          ...
                          className={`snap-center flex-shrink-0 w-auto inline-flex items-center gap-3 px-4 py-2 rounded-lg cursor-pointer select-none transition-transform transform
                            ${
                              slotTime === slot.time
                                ? "bg-blue-600 text-white scale-105"
                                : "bg-gray-100 text-gray-800 hover:-translate-y-1"
                            }
                          `}
                ...
                <div className="mt-4 flex items-center justify-between">
                  <div className="text-sm text-gray-600">
                    Selected:{" "}
                    <span className="font-medium">{slotTime || "none"}</span>
                  </div>
      ...
      <AnimatePresence>
        {isBookingOpen && (
          ...
          >
            <motion.div
              className="w-full max-w-md bg-white rounded-2xl shadow-2xl p-6 border"
            ...
            >
                ...
                <div className="flex items-center justify-between text-sm text-gray-700">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      {docSlots[slotInx] &&
                        docSlots[slotInx][0] &&
                        docSlots[slotInx][0].datetime.toLocaleDateString()}
                    </div>
                  </div>
              ...
              <div className="mt-6 flex gap-3">
                <button
                  ...
                  className="flex-1 inline-flex items-center justify-center gap-2 bg-blue-600 text-white px-4 py-2 rounded-lg shadow hover:scale-102 transition"
                >
      ...
      <AnimatePresence>
        {bookingConfirmed && (
          <motion.div
            ...
            exit={{ y: 40, opacity: 0 }}
            className="fixed bottom-8 right-8 z-50 bg-white rounded-xl shadow-lg px-4 py-3 flex items-center gap-3 border"
          >
      ...
      <style>{`
        ...
        .no-scrollbar { -ms-overflow-style: none; scrollbar-width:        .no-scrollbar::-webkit-scrollbar { display: none; }
